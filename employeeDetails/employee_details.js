...
Function to display all employees
 - The map method iterates through each employee in the employees array.
   For each employee, it constructs a string template literal <p>${employee.id}:
        ${employee.name}: ${employee.name} - ${employee.department} - $${employee.salary}</p>
   encapsulated within <p> tags, to represent employee details.
...
/*
Calculates employees' total salaries.
 ...
 - Each employee's salary (employee.salary) is added to the accumulator (acc).
   After calculating the total sum of salaries, an alert dialog box is triggered using alert().
   It showcases the total calculated salaries with the message "Total Salaries: $" followed by the computed totalSalaries variable value.
   This alert displays the overall sum of all employee salaries.
*/
...
/*
Displays employees details based on department such as the HR department.

 - The code filters the employees array using the filter array method,
...
Displays employees' details based on ID.
 ...
 - This code uses the find method to locate an employee in the employees array whose ID matches the provided employee ID,
   storing the found employee object in the foundEmployee variable.
...
/*
Displays employee's details based on their specialization
*/
